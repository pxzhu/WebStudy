...
>Install(> Python, Ruby )    
>Number(> ceil, floor, pow, pi )    
>String(> capitalize, upper&upcase, __len__[len]&length, replace&sub, escape, ''&"" )    
...
- 2020-10-06
>Function(> expression, skip, block[times, upto, each, delete_if] )    
...
1. 생활코딩 - 리액트 (React)
1. [생활코딩 - Python & Ruby](https://opentutorials.org/course/1750)(79/111)
